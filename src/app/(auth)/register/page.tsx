      ...
      <form action={formAction} onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            required
            placeholder="••••••••"
            className={`w-full rounded-lg border bg-gray-950/80 px-3 py-2.5 text-sm text-white placeholder-gray-600 transition-colors focus:outline-none focus:ring-2 ${
              confirmError
